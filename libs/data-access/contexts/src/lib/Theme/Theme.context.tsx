...
export type AppThemeProperties = {
  primaryColor?: AppPalette;
};

const AppTheme = ({ primaryColor }: AppThemeProperties): Theme =>
  createTheme({
    palette: {
      primary: { main: primaryColor ?? AppPalette.BLUE },
...
type ThemeContextProps = { children: React.ReactNode } & AppThemeProperties;
