...
describe('<WorkerPermissions />', () => {
  it('should render properly', () => {
    ...
    expect(screen.getByTitle('worker-createEventTemplates')).toBeInTheDocument();
    expect(screen.getByTitle('worker-updateEventTemplates')).toBeInTheDocument();
    expect(screen.getByTitle('worker-deleteEventTemplates')).toBeInTheDocument();
    ...
    expect(screen.getByTitle('worker-createEventAppointments')).toBeInTheDocument();
    expect(screen.getByTitle('worker-updateEventAppointments')).toBeInTheDocument();
    expect(screen.getByTitle('worker-deleteEventAppointments')).toBeInTheDocument();
    
    expect(screen.getByText('Calendar appointments')).toBeInTheDocument();
    expect(screen.getByTitle('worker-createCalendarAppointments')).toBeInTheDocument();
    expect(screen.getByTitle('worker-updateCalendarAppointments')).toBeInTheDocument();
    expect(screen.getByTitle('worker-deleteCalendarAppointments')).toBeInTheDocument();
  });
});
